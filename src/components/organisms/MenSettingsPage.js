    ...
    return (
        ...
        >
            ...
            >
                        ...
                        <Box sx={{ display: "flex", flexDirection: "column", gap: 2 }}>
                            <Box sx={{ display: "flex", gap: 2, flexWrap: "wrap" }}>
                                ...
                                <TextField
                                    ...
                                    variant="outlined"
                                    fullWidth
                                    value={formData.mentorID.toUpperCase()}
                                    onChange={(e) => {
                ...
                {activeStep === 1 && (
                    <>
                        ...
                        <FormControl fullWidth sx={{ mb: 2 }}>
                            <Typography sx={{ color: 'white', mb: 1 }}>Employee in</Typography>
                            <TextField
                        ...
                        <FormControl fullWidth>
                            <Typography sx={{ color: 'white', mb: 1 }}>Choose your major</Typography>
                            <TextField
                        ...
                        <FormControl fullWidth sx={{ mt: 3 }}>
                            <Typography sx={{ color: 'white', mb: 1 }}>Tech Stacks</Typography>
                            <TextField
                ...
                {activeStep === 2 && (
                    <>
                        <Typography variant="h6" sx={{ fontWeight: "bold", mb: 1, color: GOLD_LIGHT }}>
                            Profile Details
                        </Typography>
                        <Divider sx={{ mb: 3, borderColor: `${GOLD_MAIN}40` }} />
